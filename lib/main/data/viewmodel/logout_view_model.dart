...
class LogoutViewModel extends StateNotifier<ConfigState> {
  final ClientProfileRepository repository;

  LogoutViewModel({required this.repository}) : super(ConfigInitial());

  Future<void> logout() async {
    state = ConfigLoading();
    try {
      final clientProfile = await repository.logout();
