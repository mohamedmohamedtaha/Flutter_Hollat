...
class ServiceConfigResponseModel extends ServiceConfigResponse {
  const ServiceConfigResponseModel({required super.nafathEnabled,
    ...
    required super.verifyMobileAfterLoginWithEmail,
    required super.verifyEmailAfterSelfServiceLoginRequired,
    required super.verifyEmailAfterSelfServiceLoginEnabled});
  ...
  factory ServiceConfigResponseModel.fromJson(Map<String, dynamic> json) =>
      ServiceConfigResponseModel(
          ...
          theme: ThemeConfigModel.fromJson(
          ...
          verifyMobileAfterLoginWithEmail: VerifyMobileAfterLoginWithEmailModel
              .fromJson(
              json['VERIFY_MOBILE_AFTER_LOGIN_WITH_EMAIL'] as Map<
                  String,
                  dynamic>),
          verifyEmailAfterSelfServiceLoginRequired:
          VerifyEmailAfterSelfServiceLoginRequiredModel.fromJson(
              json['VERIFY_EMAIL_AFTER_SELF_SERVICE_LOGIN_REQUIRED'] as Map<
                  String,
                  dynamic>),
          verifyEmailAfterSelfServiceLoginEnabled:
          VerifyEmailAfterSelfServiceLoginEnabledModel.fromJson(
              json['VERIFY_EMAIL_AFTER_SELF_SERVICE_LOGIN_ENABLED'] as Map<
                  String,
                  dynamic>));
  ...
  Map<String, dynamic> toJson(ServiceConfigResponseModel instance) =>
      <String, dynamic>{
        ...
        'VERIFY_EMAIL_AFTER_SELF_SERVICE_LOGIN_REQUIRED':
        instance.verifyEmailAfterSelfServiceLoginRequired,
        'VERIFY_EMAIL_AFTER_SELF_SERVICE_LOGIN_ENABLED':
        instance.verifyEmailAfterSelfServiceLoginEnabled
      };
}
